      ...
      <section className="py-32 bg-surface-alt" id="features">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
            ...
            <div className=" lg:col-span-8 bg-card rounded-3xl p-10 border border-border flex flex-col justify-between overflow-hidden relative group transition-all">
              ...
              <div className="mt-12 flex flex-wrap items-center gap-2">
                {['"Coffee $4.50"', '"Lunch 15 EUR"', '"Taxi PKR 2500"'].map((chip, i) => (
                  <div key={chip} className={`px-4 py-2 rounded-full text-xs font-bold italic ${i === 2
            ...
            <div className="lg:col-span-4 bg-primary rounded-3xl p-10 text-primary-foreground flex flex-col justify-between group hover:bg-primary/90 transition-all">
              <div>
